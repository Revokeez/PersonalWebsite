...
const ProjectsAndAwards = () =>{
    ...
    return (
        <>
            {/*
                Explaining code: <div id="projectsandawards"></div>

                For when the user click Projects and Awards in navbar it sends them to the navbar section.

                NOTE: The reason the id of "projectsandawards" is in a seperated div is because when
